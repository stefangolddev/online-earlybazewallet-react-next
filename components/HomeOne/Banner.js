      ...
      <div className='main-banner-area'>
        <div className='container'>
          <div className='main-banner-box'>
            ...
            <button type='submit'>
              <i className='bx bxs-hand-right'></i> Transfer
            </button>
          </div>
          <div className='row align-items-center m-0'>
            <div className='col-xl-6 col-lg-6 col-md-12 p-0'>
              <div className='main-banner-content'>
                <h1>Sell Cryptocurrency Easy, Fast and Secure!</h1>
                <p>
                  We buy Cryptocurrency from you and send cash to your respective bank account easy, fast and secure, our records are live and you get exactly the current pricing.
                </p>
