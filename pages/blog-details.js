              ...
              <div className='content'>
                ...
                <div className='post-author-meta'>
                  <div className='d-flex align-items-center'>
                    ...
                    <div className='title'>
                      <span className='name'>
                        By <a href='blog.html'>EnvyTheme</a>
                      </span>
          ...
          <div className='blog-details-desc'>
            <div className='article-content'>
              ...
              <p>
                ...
                Neque porro quia non jgstaa numquam eius modi tempora incidunt
                ut labore et dolore magnam dolor sit amet, consectetur
                adipisicing voluptatem sequi nesciunt.
              </p>
              <p>
              ...
              <blockquote className='wp-block-quote'>
                <p>
                  It is a long established fact that a reader will be distracted
                  by the readable when content of a page when looking at its
                  layout.
                </p>
                  ...
                  <div className='row'>
                    ...
                    <div className='col-lg-4 col-md-5 col-sm-12'>
                      <button type='submit' className='default-btn'>
                        <i className='bx bx-paper-plane'></i> Post A Comment
                      </button>
                    </div>
              ...
              <div className='single-blog-post'>
                ...
                <div className='post-content'>
                  ...
                  <div className='author d-flex align-items-center'>
                    ...
                    <a href='blog.html'>David Warner</a>
                  </div>
                  <a href='blog-details.html' className='link-btn'>
                    <i className='bx bx-right-arrow-alt'></i>
                  </a>
